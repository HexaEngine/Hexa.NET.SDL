...
namespace Hexa.NET.SDL3
{
	...
	public partial struct SDLGamepadButtonEvent
	{
		...
		public unsafe SDLGamepadButtonEvent(SDLEventType type = default, uint reserved = default, ulong timestamp = default, int which = default, byte button = default, byte state = default, byte padding1 = default, byte padding2 = default)
		{
			Type = type;
			Reserved = reserved;
			Timestamp = timestamp;
